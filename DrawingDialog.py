...
from PySide6.QtWidgets import (QDialog, QPushButton, QStackedLayout,
    QLabel, QTableWidget, QAbstractItemView, QHeaderView, QTableWidgetItem)
...
class DrawingDialog(QDialog):
    ...
    def setupUI(self, MainWindow: QDialog) -> None:
        MainWindow.setWindowTitle("Drawing")
        MainWindow.resize(920, 560)
        MainWindow.setWindowIcon(QPixmap("./assets/icons/DrawingDialog.png"))
