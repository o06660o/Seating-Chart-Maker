...
"py -m nuitka --standalone --enable-plugin=pyside6 --show-memory --show-progress --onefile --windows-disable-console --windows-icon-from-ico=assets/icons/MainWindow.jpg --run main.py MainWindow.py SettingsDialog.py DrawingDialog.py util.py"
